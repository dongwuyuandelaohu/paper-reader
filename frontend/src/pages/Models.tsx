...
const providerStyles: Record<Provider, { bg: string; color: string; label: string }> = {
  openai: { bg: '#e8f5ee', color: '#2d7a4f', label: 'OpenAI' },
  anthropic: { bg: '#f0e8fe', color: '#6b4fc0', label: 'Anthropic' },
  google: { bg: '#e8f0fe', color: '#3b6fc0', label: 'Google' },
  other: { bg: '#f0eee6', color: '#5e5d59', label: 'Other' },
}
